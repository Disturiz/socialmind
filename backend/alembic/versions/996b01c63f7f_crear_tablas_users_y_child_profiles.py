"""crear tablas users y child_profiles

Revision ID: 996b01c63f7f
Revises: 
Create Date: 2026-06-16 23:31:17.043598
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('admin', 'parent', 'specialist', name='userrole'), nullable=False),
