...
function StepObjective({ step }) {
  return (
    <div className="flex flex-col gap-4 text-center">
      <p className="text-base font-bold text-primary-500 uppercase tracking-wide">
        Objetivo
      </p>
...
function StepExplanation({ step }) {
  return (
    <div className="flex flex-col gap-4">
      <p className="text-base font-bold text-secondary-600 uppercase tracking-wide text-center">
        Explicación
      </p>
...
function StepPractice({ step, onAnswer }) {
  ...
  return (
    <div className="flex flex-col gap-4">
      <p className="text-base font-bold text-accent-yellow uppercase tracking-wide text-center">
        Practiquemos
      </p>
...
function StepFeedback({ step }) {
  return (
    <div className="flex flex-col gap-4 text-center">
      <p className="text-base font-bold text-secondary-600 uppercase tracking-wide">
        Retroalimentación
      </p>
      ...
      <div className="max-w-md mx-auto w-full flex flex-col gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <p className="text-base text-text-muted font-semibold">{scenario.emoji} {scenario.title}</p>
          </div>
        </div>
